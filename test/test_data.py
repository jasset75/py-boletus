...
def check_draw(df_lot,draw,f_out=None,experiment='results',sort=True):
  df = df_lot.copy()
  df['draw'] = draw
  df['success'] = 0
  df['comp'] = False
